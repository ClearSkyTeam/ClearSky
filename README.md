...
###  [Українська мова](https://github.com/ClearSkyTeam/ClearSky#Українська мова)  
...
All features can be configed in pocketmine.yml.<br>
 ...
 - Universal Client version join(e.g. 0.14.0 and buils for 0.14.0 can join together)(note¹)
