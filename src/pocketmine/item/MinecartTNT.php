...
class MinecartTNT extends Item{
	...
	public function __construct($meta = 0, $count = 1){
		parent::__construct(self::TNT_MINECART, $meta, $count, "TNT Minecart");
	}
	...
	public function onActivate(Level $level, Player $player, Block $block, Block $target, $face, $fx, $fy, $fz){
		...
		$cart = new MinecartTNTEntity($player->getLevel()->getChunk($realPos->getX() >> 4, $realPos->getZ() >> 4), new CompoundTag("", [
			"Pos" => new ListTag("Pos", [
