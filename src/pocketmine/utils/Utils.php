...
class Utils{
	 ...
	 * @param string $startEntropy @deprecated
	 * @param int    &$rounds      @deprecated
	 * @param int    &$drop        @deprecated
	 *
	 *
	 * @return string
	 */
	public static function getRandomBytes($length = NULL, $secure = NULL, $raw = true, $startEntropy = NULL, &$rounds = NULL, &$drop = NULL){
	...
	public static function getURL($page, $timeout = 10, array $extraHeaders = []){
		...
		$ch = curl_init($page);
		curl_setopt($ch, CURLOPT_HTTPHEADER, array_merge(["User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64; rv:12.0) Gecko/20100101 Firefox/12.0 ClearSky"], $extraHeaders));
